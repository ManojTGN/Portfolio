    ...
    return <>
            <div className="mt-5 border-l pl-5 border-portfolio-500 flex">
                ...
                <div className="w-full flex flex-col gap-5 text-portfolio-500">
                    <input onInput={validateInput} maxLength={30} type="text" className="disabled:cursor-not-allowed border-2 border-portfolio-700 bg-portfolio-950 h-12 p-2" placeholder={t('portfolio.contact.name.placeholder')} id="name" disabled={inputDisable}/>
                    <input onInput={validateInput} maxLength={40} type="email" className="disabled:cursor-not-allowed border-2 border-portfolio-700 bg-portfolio-950 h-12 p-2" placeholder={t('portfolio.contact.email.placeholder')} id="email" disabled={inputDisable}/>
                    <textarea onInput={validateInput} maxLength={500} className="disabled:cursor-not-allowed h-56 min-h-32 max-h-56 border-2 border-portfolio-700 bg-portfolio-950 p-2" placeholder={t('portfolio.contact.message.placeholder')} id="message" disabled={inputDisable}></textarea>
