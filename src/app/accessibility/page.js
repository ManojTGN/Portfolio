        ...
        <>
            <div className="w-full flex flex-col items-center justify-center">
                <div className="w-6/12 flex flex-col justify-center">
                    <Topbar />
                    <hr className="w-full mt-5 dark:border-portfolio-500" />
                    <div className="flex items-center w-full mt-16 gap-2" id="accessibility">
                        <a href="#accessibility" className="w-full font-medium text-4xl dark:text-white">{t('portfolio.topbar.accessibility')}</a>
                    </div>

                    <div className="flex items-center w-full mt-10 gap-2" id="language">
                        <div className="w-full">
                            <a href="#language" className="w-full font-medium text-2xl dark:text-white">{t('portfolio.a11y.language')}</a>
                    ...
                    <div className="flex items-center w-full mt-10 gap-2" id="fontSize">
                        <div className="w-full">
                            <a href="#fontSize" className="w-full font-medium text-2xl dark:text-white">{t('portfolio.a11y.font.size')}</a>
                            <p className="w-full text-lg text-portfolio-500 dark:text-portfolio-500">{t('portfolio.a11y.font.size.desc')}</p>
                        </div>
