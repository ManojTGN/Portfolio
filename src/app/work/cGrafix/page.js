        ...
        <div className="w-full flex flex-col items-center justify-start">
            <div className="w-11/12 md:w-9/12 lg:w-6/12 flex flex-col">
                ...
                <div className="flex items-center justify-between mt-6">
                    ...
                    <a href="https://github.com/ManojTGN/cGrafix" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-portfolio-500 hover:text-portfolio-300 transition-colors">
                ...
                <div className="mt-8">
                    <Image
                        src="/images/work/project/cGrafix/cGrafix.png"
                        alt="cGrafix"
                        width={1080}
                        height={200}
                        draggable="false"
                ...
                <section className="mt-10">
                    ...
                    <div className="border-l-2 pl-5 mt-4 border-portfolio-500">
                        <p className="text-portfolio-500 text-lg">
                            {t('portfolio.featured.cgrafix.desc')}
                        </p>
                    </div>
                </section>
